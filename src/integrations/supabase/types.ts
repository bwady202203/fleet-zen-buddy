  ...
  public: {
    Tables: {
      ...
      smart_journal_account_visibility: {
        ...
        Relationships: [
          {
            foreignKeyName: "smart_journal_account_visibility_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "chart_of_accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "smart_journal_account_visibility_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      smart_journal_drafts: {
        ...
        Relationships: [
          {
            foreignKeyName: "smart_journal_drafts_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "chart_of_accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "smart_journal_drafts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      transfer_request_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "transfer_request_items_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "chart_of_accounts"
            referencedColumns: ["id"]
      ...
      transfer_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "transfer_requests_journal_entry_id_fkey"
            columns: ["journal_entry_id"]
            isOneToOne: false
            referencedRelation: "journal_entries"
            referencedColumns: ["id"]
      ...
      watched_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "watched_accounts_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "chart_of_accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "watched_accounts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
