    ...
    try {
      ...
      aggregatedContainer.innerHTML = `
        <div style="text-align: center; margin-bottom: 15px;">
          <h1 style="color: #1a1a1a; font-size: 20px; margin: 0 0 6px 0; font-weight: bold;">تقرير عمولات السائقين</h1>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: 15px;">
          ...
          <div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 12px; border-radius: 6px; text-align: center; color: white;">
            <div style="font-size: 20px; font-weight: bold; margin-bottom: 4px;">${totalCommissions.toLocaleString()} ر.س</div>
            <div style="font-size: 9px; opacity: 0.95;">إجمالي العمولات</div>
          </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; font-size: 9px; table-layout: fixed;">
          <thead>
            <tr style="background: #f8f9fa;">
              <th style="padding: 6px 8px; text-align: right; border: 1px solid #dee2e6; font-weight: bold;">السائق</th>
              <th style="padding: 6px 8px; text-align: center; border: 1px solid #dee2e6; font-weight: bold; width: 80px;">عدد الرحلات</th>
              <th style="padding: 6px 8px; text-align: center; border: 1px solid #dee2e6; font-weight: bold; width: 110px;">العمولات</th>
          ...
          <tbody>
            ${aggregatedData.map((item, index) => `
              <tr style="background: ${index % 2 === 0 ? "#ffffff" : "#f8f9fa"};">
                <td style="padding: 6px 8px; text-align: right; border: 1px solid #dee2e6; word-wrap: break-word;">${item.driver_name}</td>
                <td style="padding: 6px 8px; text-align: center; border: 1px solid #dee2e6;">${item.total_loads}</td>
                <td style="padding: 6px 8px; text-align: center; border: 1px solid #dee2e6; font-weight: bold;">${item.total_commissions.toLocaleString()} ر.س</td>
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 9px; table-layout: fixed;">
          <thead>
            <tr style="background: #f8f9fa;">
              ...
              <th style="padding: 6px 8px; text-align: center; border: 1px solid #dee2e6; font-weight: bold; width: 100px;">العمولات</th>
              <th style="padding: 6px 8px; text-align: center; border: 1px solid #dee2e6; font-weight: bold; width: 100px;">المبلغ</th>
            </tr>
          </thead>
          <tbody>
