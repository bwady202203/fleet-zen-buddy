              ...
              <Table>
                ...
                <TableBody>
                  {openingEntryData.lines.map((line) => {
                    ...
                    const level4AssetsLiabilities = accounts.filter(acc => 
                      calculateLevel(acc) === 4 && (acc.type === 'asset' || acc.type === 'liability')
                    );
                    const filteredAccounts = level4AssetsLiabilities.filter(acc => 
