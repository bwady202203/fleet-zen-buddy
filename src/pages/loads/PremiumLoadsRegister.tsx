...
import { ArrowRight, Plus, Save, Check, ChevronsUpDown, Sparkles } from "lucide-react";
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="deliveryFrom">التوصيل من / Delivery From</Label>
                  <Input
                    id="deliveryFrom"
                    value={formData.deliveryFrom}
                    onChange={(e) => setFormData({ ...formData, deliveryFrom: e.target.value })}
                    placeholder="نقطة التحميل"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="deliveryTo">التوصيل الى / Delivery To</Label>
                  <Input
                    id="deliveryTo"
