...
import { ArrowRight, BookOpen, FileText, BarChart3, DollarSign, Receipt, Wallet, ShoppingCart, Package, RotateCcw, Target, FolderKanban, FileBarChart, Download, ClipboardList, Sparkles, Calendar, Printer, FileDown, Building2, Landmark, Crown, Lock, PiggyBank, SendHorizontal, FileImage } from "lucide-react";
...
const Accounting = () => {
  ...
  const premiumSections = [
    {
      title: "قيد يومية مع المستند",
      description: "الصق صورة إشعار البنك واقرأ بياناته وأنشئ القيد تلقائياً",
      icon: FileImage,
      link: "/accounting/journal-document-entry",
